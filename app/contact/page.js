...
import { FaPhone, FaEnvelope, FaMapMarkerAlt, FaAnchor, FaHotel, FaClock } from 'react-icons/fa';
        ...
        <div className="container-max">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to discuss your yacht or hotel maintenance project? Our expert team is here to help.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                className="text-center bg-warm-gray p-6 card-hover"
              >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="yacht-construction">Yacht Construction</option>
                        <option value="yacht-transformation">Yacht Transformation</option>
                        ...
                        <option value="annual-contract">Annual Maintenance Contract</option>
                      </select>
                    </div>
                  </div>
                  <div>
            ...
            >
              ...
              <div className="bg-gold text-white p-6 shadow-lg">
                ...
                <p className="text-gray-800 mb-4">
                  For hotel maintenance and Annual Maintenance Contract inquiries.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-800">hotelcare@emmeconstruction.com</span>
                  </div>
                </div>
              </div>
