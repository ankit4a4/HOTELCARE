        ...
        <section className="relative  h-[40vh] md:h-[350px] overflow-hidden md:py-20 py-10 px-4">
            ...
            <div className="max-w-6xl mx-auto text-center text-white relative z-10">
                <motion.h1
                    ...
                    viewport={{ once: true }}
                >
                    Tailored Maintenance for<br />
                    <span className="text-[#b8a86e]">Hospitality Excellence</span>
                </motion.h1>
                ...
                <motion.p
                    ...
                    viewport={{ once: true }}
                >
                    From boutique hotels to large-scale resorts, we ensure every space is functional, elegant, and guest-ready.
                </motion.p>
